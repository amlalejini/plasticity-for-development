...
EMP_BUILD_CONFIG( DOLWorldConfig,
  ...
  VALUE(PERIODIC_RESOURCES__FAILURE_COST, double, 25.0, "What is the cost of attempting to consume an unavailable static resource?"),
  ...
  VALUE(PERIODIC_RESOURCES__DECAY_FIXED, double, 100.0, "How many resources are decayed at a time?"),
  VALUE(PERIODIC_RESOURCES__DECAY_PROPORTIONAL, double, 1.0, "What proportion of a periodic resource decays?"),
  VALUE(PERIODIC_RESOURCES__PULSE_PROB, double, 0.1, "If a resource is eligable to pulse, what is the probability of pulsing?"),

  VALUE(NUM_STATIC_RESOURCES, size_t, 1, "How many tasks are always rewarded?"),
  VALUE(STATIC_RESOURCES__LEVEL, double, 10.0, "How much of a static resource is made available every update?"),

  VALUE(STATIC_RESOURCES__CONSUME_FIXED, double, 10.0, "How much of a static resource is collected when metabolized?"),
  ...
  VALUE(PROGRAM_ARG_SUB__PER_ARG, double, 0.00125, "Program argument substitution rate (per-argument)"),
  VALUE(PROGRAM_INST_SUB__PER_INST, double, 0.0025, "Program instruction substitution rate (per-instruction)"),
  VALUE(PROGRAM_INST_INS__PER_INST, double, 0.0025, "Program instruction insertion rate (per-instruction)"),
  VALUE(PROGRAM_INST_DEL__PER_INST, double, 0.0025, "Program instruction deletion rate (per-instruction)"),
